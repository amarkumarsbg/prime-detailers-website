            ...
            <StaggerItem>
              <div className="mt-10 flex flex-wrap items-center justify-center gap-5">
                ...
                <Button 
                  ...
                  className="btn-marketing group h-14 rounded-full border-white/30 bg-white/5 px-8 text-lg font-semibold text-white shadow-lg backdrop-blur-md transition-all hover:scale-105 hover:bg-white/10 hover:text-white animate-float-delayed"
                >
                  <Play className="size-5 mr-2 fill-white/80 transition-transform group-hover:scale-110" />
                  Watch Demo
                </Button>
              </div>
            </StaggerItem>
